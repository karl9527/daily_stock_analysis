...
示例:
  ...
  python main.py --start-date 2026-02-01 --end-date 2026-02-28  # 指定日期范围
  python main.py --days 60          # 获取最近60天的数据
        '''
    )
    ...
    parser.add_argument(
        '--start-date',
        type=str,
        help='指定数据获取开始日期（格式：YYYY-MM-DD，例如：2026-02-01）'
    )

    parser.add_argument(
        '--end-date',
        type=str,
        help='指定数据获取结束日期（格式：YYYY-MM-DD，默认为今天）'
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=30,
        help='获取最近N天的数据（默认30天，当未指定 --start-date 时生效）'
    )
